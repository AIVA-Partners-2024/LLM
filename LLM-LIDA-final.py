...
file_path = r"C:\Users\nakul.vasani\OneDrive - AIVA Partners Pvt. Ltd\Desktop\test-data.csv"
...
def generate_and_display_graph(user_input):
    ...
    csv_path = r"C:\Users\nakul.vasani\OneDrive - AIVA Partners Pvt. Ltd\Desktop\test-data.csv"  # Adjust the path as necessary
